...
axes[0,0].violinplot(np.array( cloud_pixels[bands] ), range(1,14), showmeans=True, showextrema=False)
axes[0,0].set_title('Cloud')

axes[0,1].violinplot(np.array( land_pixels[bands] ), range(1,14), showmeans=True, showextrema=False)
axes[0,1].set_title('Land')

axes[1,0].violinplot(np.array( water_pixels[bands] ), range(1,14), showmeans=True, showextrema=False)
axes[1,0].set_title('Water')

axes[1,1].violinplot(np.array( shadow_pixels[bands] ), range(1,14), showmeans=True, showextrema=False)
